...
def _full_status():
    return {
        ...
        "background_stats": {
            "backgrounds": 4,
            "usable_background_scripts": 4,
            "unusable_background_scripts": 3,
            "scripts": {
                "scanned": 9,
                "decoded": 7,
                "decode_failed": 1,
            ...
            "economy_fields": {
                "hiring_cost": {"local": 3, "inherited": 2, "unresolved": 2},
                "daily_cost": {"local": 2, "inherited": 3, "unresolved": 2},
            },
            "identifiers": {"explicit": 6, "inferred": 1},
            "parse_seconds": 0.555,
        },
        "perk_stats": {
            "perks": 13,
...
def test_print_reference_status_full_contract(capsys):
    ...
    expected_fragments = [
        ...
        "4 entries from 4 usable scripts · 3 unusable / 7 decoded",
        "local=3 · inherited=2 · unresolved=2",
        "local=2 · inherited=3 · unresolved=2",
        "explicit=6 · inferred=1",
        "scanned=9 · decoded=7 · decode failed=1 · resolution failed=1",
        "parse 0.555s",
