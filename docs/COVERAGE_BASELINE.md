...
the minimum whenever this explicit local or pre-release validation is run.
Routine PR CI intentionally does not run coverage. Raising this floor should
accompany additional committed coverage.
